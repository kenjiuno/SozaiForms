...
{
    public class SplitBitmapUsecase
    {
        public IEnumerable<Bitmap> Split(String fp)
        {
        ...
        private Bitmap Scan(Bitmap pic, int starx, int starty, int cx, int cy, bool[] scanned, Color bk)
        {
        ...
        private bool CanMove2(int x, int y, int cx, int cy, bool[] scanned)
        {
